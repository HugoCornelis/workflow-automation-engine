...
my $test
    = {
       "0_description" => {
			   features_to_be_tested => {
						     ...
						     command_options => {
									 ...
									 role => 'a role that is defined in units-configuration.',
       ...
       command_definitions => [
			       {
				command => 'cd ~/projects/workflow-automation-engine/source/snapshots/master/vigilia/specifications/workflow-configurations/feature-testing && workflow builtin configuration_install -- --bash --commands --path-in-bashrc --no-aliasses',
				command_tests => [
						  {
...
#
# ln -sf /home/neurospaces/projects/workflow-automation-engine/source/snapshots/master/vigilia/specifications/workflow-configurations/feature-testing/feature-testing-commands-features-background.py /home/neurospaces/bin/feature-testing-commands-features-background.py
#
