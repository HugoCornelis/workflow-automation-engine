...
def pure_python_python_command(argv):
...
def pure_python_python_command_completions(command, argv):
    completions_hash = {
           ...
           "4._Look_at_the_completion_function_of_pure-python_single_command_completions_to_understand_how_it_works": "further_explanation",
          }

    return completions_hash


def pure_python_python_command_help(command, perl_argv):
