...
1_commmands:
  ...
  - workflow-tests-workflow examples array_of_commands
  - workflow-tests-workflow examples array_of_commands_remote_execution
  - workflow-tests-workflow examples sequencing_and_composition
  - workflow-tests-workflow examples single_command
